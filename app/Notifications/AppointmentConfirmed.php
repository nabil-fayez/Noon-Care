...
class AppointmentConfirmed extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('تم تأكيد حجزك - Noon Care')
            ->greeting('مرحباً ' . $notifiable->first_name)
            ->line('تم تأكيد حجزك بنجاح. تفاصيل الحجز:')
            ...
            ->line('شكراً لاستخدامك تطبيق Noon Care!');
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => 'تم تأكيد حجزك',
            'message' => 'تم تأكيد حجزك مع الدكتور ' . $this->appointment->doctor->full_name .

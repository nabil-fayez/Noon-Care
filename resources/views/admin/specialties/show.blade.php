        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <form action="{{ route('admin.specialty.toggleStatus', $specialty) }}" method="POST" class="d-inline">
                        @csrf
                        ...
                        <div class="col-md-4">
                            <div class="text-center mb-4">
                                @if($specialty->icon_url)
                                    <img src="{{ $specialty->icon_url }}" class="rounded mb-3" width="150" height="150" alt="أيقونة التخصص">
                                @else
                                ...
                                @if($specialty->color)
                                    <div class="mb-3">
                                        <span class="badge" style="background-color: {{ $specialty->color }}; color: white">
                                            لون التخصص
                                        </span>
                                    </div>
                                @endif
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="border rounded p-3">
                                                <h4 class="text-info">{{ $specialty->updated_at->diffForHumans() }}</h4>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ $doctor->profile_image_url ?? 'https://via.placeholder.com/40' }}" 
                                                             class="rounded-circle" width="40" height="40" alt="صورة الطبيب">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.doctor.show', $doctor) }}" class="btn btn-sm btn-info">
                                                            عرض
                                                        </a>
                                                    </td>
                                                </tr>

        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            action="{{ isset($specialty) ? route('admin.specialty.update', $specialty) : route('admin.specialties.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">اسم التخصص <span
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="color"
                                            ...
                                            id="color" name="color"
                                            value="{{ old('color', $specialty->color ?? '#0d6efd') }}">
                                        @error('color')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if (isset($specialty) && $specialty->icon_url)
                                    <div class="mt-2">
                                        ...
                                        <img src="{{ $specialty->icon_url }}" class="rounded" width="60" height="60"
                                            alt="أيقونة التخصص">
                                    </div>
                                @endif
                            </div>
                            ...
                            @if (isset($specialty))
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                        value="1" {{ old('is_active', $specialty->is_active) ? 'checked' : '' }}>

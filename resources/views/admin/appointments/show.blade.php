                        ...
                        <div class="mt-4">
                            <form action="{{ route('admin.appointments.updateStatus', $appointment) }}" method="POST"
                                ...
                                <div class="btn-group" role="group">
                                    <button type="submit" name="status" value="confirmed" class="btn btn-success">تأكيد
                                        الحجز</button>
                                    <button type="submit" name="status" value="done" class="btn btn-info">تم
                                        الإكمال</button>
                                    <button type="submit" name="status" value="cancelled" class="btn btn-danger">إلغاء
                                        الحجز</button>
                                </div>
                            </form>
                        </div>

            ...
            <div class="col-md-2">
                <div class="list-group">
                    <a href="{{ route('admin.dashboard') }}" class="list-group-item list-group-item-action active">لوحة
                        التحكم</a>
                    <a href="{{ route('admin.doctors.index') }}" class="list-group-item list-group-item-action">الأطباء</a>
                    <a href="{{ route('admin.specialties.index') }}" class="list-group-item list-group-item-action">التخصصات
                        الطبية</a>
                    <a href="{{ route('admin.patients.index') }}" class="list-group-item list-group-item-action">المرضى</a>
                    ...
                    <a href="{{ route('admin.logout') }}" class="list-group-item list-group-item-action">تسجيل الخروج</a>
                </div>
            </div>
